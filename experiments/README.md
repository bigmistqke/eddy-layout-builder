...
| 17b | [render-loop-paced](17b_render-loop-paced/README.md) | Same as 17 but with decoders paced to 30fps instead of flat-out. Does the production pacing model recover the budget? | _not yet run_ |
