...
| 24c | [incremental-rebuild](24c_incremental-rebuild/README.md) | Does serial incremental atlas rebuild (one atlas at a time, queued on edits) keep D bounded under varying edit rates? Sweeps R ∈ {0.25, 0.5, 1.0, 2.0}/s. | _not yet run_ |
