...
| 26b | [cold-start-copyto-workers](26b_cold-start-copyto-workers/README.md) | 26 with VideoFrame.copyTo({format:'RGBA'}) replacing canvas roundtrip, AND per-cell worker doing decode + SyncAccessHandle write. How much speedup over 26? | _not yet run_ |
