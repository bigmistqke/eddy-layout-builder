...
| 20c | [cross-codec-dual-pool](20c_cross-codec-dual-pool/README.md) | Does 19d's HW+SW additivity hold with different codecs per pool? (VP9-HW + AV1-SW). | _not yet run_ |
