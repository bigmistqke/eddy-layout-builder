...
| 27 | [session-save-encode](27_session-save-encode/README.md) | C2 session-save: encode K cells from raw RGBA to AV1 or VP9. Wall time + output size, sequential vs parallel modes, codec comparison. | _not yet run_ |
