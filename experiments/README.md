...
| 24 | [render-loop-av1-multires](24_render-loop-av1-multires/README.md) | End-to-end: K cells × per-K mip × AV1-SW decoders × rAF + texImage2D. Does 20d's single-pool multi-res architecture survive paint? | _not yet run_ |
