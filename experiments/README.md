...
| 26 | [cold-start-cache-build](26_cold-start-cache-build/README.md) | C2 architecture session-open: decode K AV1 files from OPFS → write K raw RGBA caches to OPFS in parallel. How long for K ∈ {4,9,16,25}? AV1 storage size in exchange? | _not yet run_ |
