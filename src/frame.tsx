  ...
  return (
    ...
    >
      <Show when={dirs().includes("top")}>
        <Show when={buttonDirs().includes("top")} fallback={
          <ArrowNotch class={styles.top} onClick={() => props.onAddFrame("top")} />
        }>
          <EdgeButton class={styles.top} onClick={() => props.onAddFrame("top")} />
        </Show>
      </Show>
      <Show when={dirs().includes("bottom")}>
        <Show when={buttonDirs().includes("bottom")} fallback={
          <ArrowNotch
            class={styles.bottom}
      ...
      <Show when={dirs().includes("left")}>
        <Show when={buttonDirs().includes("left")} fallback={
      ...
      <Show when={dirs().includes("right")}>
        <Show when={buttonDirs().includes("right")} fallback={
