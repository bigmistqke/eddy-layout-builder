...
export function TrashIcon(props: { class?: string }) {
  return (
    <IconContainer class={props.class}>
      ...
      >
        <path
          d="M13 25V11C13 9.89543 13.8954 9 15 9C16.1046 9 17 9.89543 17 11V25C17 26.1046 16.1046 27 15 27C13.8954 27 13 26.1046 13 25ZM20 25V11C20 9.89543 20.8954 9 22 9C23.1046 9 24 9.89543 24 11V25C24 26.1046 23.1046 27 22 27C20.8954 27 20 26.1046 20 25Z"
          fill="currentColor"
        />
        <path
          d="M4.04711 7L7.80664 36.5H29.1934L32.9529 7H35.5C36.6046 7 37.5 6.10457 37.5 5C37.5 3.89543 36.6046 3 35.5 3H26.0703L24.0703 0H13.4297L11.4297 3H2C0.89543 3 0 3.89543 0 5C0 6.10457 0.89543 7 2 7H4.04711ZM11.3291 32.5L8.0803 7H13.5703L15.5703 4H21.9297L23.9297 7H28.9197L25.6709 32.5H11.3291Z"
          fill="currentColor"
        />
      </svg>
    </IconContainer>
