...
export function HamburgerIcon(props: { class?: string }) {
  return (
    <IconContainer class={props.class}>
      ...
      >
        <path
          d="M35 0C36.1046 0 37 0.89543 37 2C37 3.10457 36.1046 4 35 4H2C0.89543 4 0 3.10457 0 2C0 0.89543 0.89543 0 2 0H35Z"
          fill="currentColor"
        />
        <path
          d="M35 9C36.1046 9 37 9.89543 37 11C37 12.1046 36.1046 13 35 13H2C0.89543 13 0 12.1046 0 11C0 9.89543 0.89543 9 2 9H35Z"
          fill="currentColor"
        />
        <path
          d="M35 18C36.1046 18 37 18.8954 37 20C37 21.1046 36.1046 22 35 22H2C0.89543 22 0 21.1046 0 20C0 18.8954 0.89543 18 2 18H35Z"
          fill="currentColor"
        />
      </svg>
    </IconContainer>
